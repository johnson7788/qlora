...
if CHAT_LANG == 'English':
    ...
    args.MODEL_NAME = '/media/wac/backup/john/johnson/FastChat/rwkv-4-raven/RWKV-4-Raven-7B-v8-Eng49%-Chn50%-Other1%-20230412-AltVersion-ctx4096'
...
# assert os.path.exists(args.MODEL_NAME), f'ERROR: Model {args.MODEL_NAME} not found!'
args.ctx_len = 10000
