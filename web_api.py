...
def parse_args():
    ...
    parser.add_argument('-m', '--model_name_or_path', type=str, default="belle-7b", help='使用的base模型')
...
if __name__ == '__main__':
    ...
    model_name2path = {
        ...
        "belle-7b": "/home/wac/johnson/project/model/BELLE-LLaMA-EXT-7B",
    }
    ...
    app.run(host='0.0.0.0', port=7063, debug=False, threaded=True)
